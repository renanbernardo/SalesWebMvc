...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department dpt1 = new Department(1, "Computers");
            Department dpt2 = new Department(2, "Electronics");
            Department dpt3 = new Department(3, "CDs");
            Department dpt4 = new Department(4, "Books");

            Seller s1 = new Seller(1, "Boca", "boca@email.com", new DateTime(1960, 02, 01), 5600.65, dpt4);
            Seller s2 = new Seller(2, "Chimbica", "chimbica@email.com", new DateTime(1990, 05, 20), 9600.65, dpt3);
            Seller s3 = new Seller(3, "Cidinha", "cidinha@email.com", new DateTime(1981, 01, 30), 10600.65, dpt2);
            Seller s4 = new Seller(4, "Zé Loquinho", "zeloquinho@email.com", new DateTime(1986, 10, 01), 7600.65, dpt1);
            Seller s5 = new Seller(5, "Pipoca", "pipoca@gmail.com", new DateTime(2000, 1, 9), 4000.0, dpt3);
            Seller s6 = new Seller(6, "Malu", "malu@gmail.com", new DateTime(1997, 3, 4), 3000.0, dpt2);
            ...
            _context.Department.AddRange(dpt1, dpt2, dpt3, dpt4);
